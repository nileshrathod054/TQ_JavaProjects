...
public class EmployeeMain {
	public static void main(String[] args) {
		...
		System.out.println("Employee Sorting By Department=" + hm1);
		...
		while (it1.hasNext()) {
			...
			if (hm2.containsKey(s1)) {
				ArrayList<String> al2 = hm2.get(s1);
				al2.add(e.name);
				hm2.put(s1, al2);
			} else {
				ArrayList<String> al2 = new ArrayList<>();
		...
		System.out.println("Employee Sorting By Address" + hm2);
	}
}
