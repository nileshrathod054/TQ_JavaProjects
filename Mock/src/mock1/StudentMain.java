...
public class StudentMain {
	public static void main(String[] args) {
		...
		Student s2 = new Student(2, "Sita", new Course(102, "Angular"));
		Student s3 = new Student(3, "Lakshaman", new Course(101, "Java"));
		Student s4 = new Student(4, "Ravan", new Course(102, "Angular"));
		Student s5 = new Student(5, "Hanuman", new Course(103, "C++"));
